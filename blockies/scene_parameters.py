...
class SceneParameters():
    ...
    def __post_init__(self):
        ...
        if type(self.bg_color_rgba) is list:
            self.bg_color_rgba = tuple(self.bg_color_rgba)
        if type(self.obj_color_rgba) is list:
            self.obj_color_rgba = tuple(self.obj_color_rgba)
        if type(self.resolution) is list:
            self.resolution = tuple(self.resolution)
        if type(self.ill_chars) is list:
